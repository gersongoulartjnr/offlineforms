...
public class Rule {
	...
	private void createRules() {
        ...
        permission[SHARED_HIERARCHICAL.getId()][ANSWER.getId()][LIST.getId()]  	= new Permission(UPDATE);
        ...
        permission[SHARED_SOCIAL.getId()][ANSWER.getId()][LIST.getId()]   		= new Permission(READ, UPDATE);
        ...
        permission[PUBLIC.getId()][ANSWER.getId()][LIST.getId()]   				= new Permission(READ, UPDATE);
        permission[PUBLIC.getId()][ANSWER.getId()][ALL.getId()] 	 			= new Permission(READ, UPDATE);
        
        // reports
        permission[PRIVATE.getId()][REPORT.getId()][OWNER.getId()]  			= new Permission(READ, UPDATE, DELETE, SHARE);
        permission[PRIVATE.getId()][REPORT.getId()][LIST.getId()]   			= new Permission();
        permission[PRIVATE.getId()][REPORT.getId()][ALL.getId()] 	  			= new Permission();
        
        permission[SHARED_HIERARCHICAL.getId()][REPORT.getId()][OWNER.getId()]  = new Permission(READ, UPDATE, DELETE, SHARE);
        permission[SHARED_HIERARCHICAL.getId()][REPORT.getId()][LIST.getId()]  	= new Permission();
        permission[SHARED_HIERARCHICAL.getId()][REPORT.getId()][ALL.getId()]  	= new Permission();
       
        permission[SHARED_SOCIAL.getId()][REPORT.getId()][OWNER.getId()]  		= new Permission(READ, UPDATE, DELETE, SHARE);
        permission[SHARED_SOCIAL.getId()][REPORT.getId()][LIST.getId()]   		= new Permission(READ, UPDATE);
        permission[SHARED_SOCIAL.getId()][REPORT.getId()][ALL.getId()] 			= new Permission();
        
        permission[PUBLIC.getId()][REPORT.getId()][OWNER.getId()]  				= new Permission(READ, UPDATE, DELETE, SHARE);
        permission[PUBLIC.getId()][REPORT.getId()][LIST.getId()]   				= new Permission(READ, UPDATE);
        permission[PUBLIC.getId()][REPORT.getId()][ALL.getId()] 	 			= new Permission(READ, UPDATE);
	}
