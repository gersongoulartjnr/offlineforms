...
const QString OAuth2::AUTH_END_POINT="http://localhost:8080/maritaca/oauth/authorizationRequest";

//const QString OAuth2::TOKEN_END_POINT="http://localhost:8080/maritaca/oauth/oauth/accesstoken";
const QString OAuth2::TOKEN_END_POINT="http://localhost:8080/maritaca/oauth/accessTokenRequest";
...
void OAuth2::on_startBtn_clicked()
{
    ...
    url.addQueryItem("client_secret", ui->clientSecret1->text());
