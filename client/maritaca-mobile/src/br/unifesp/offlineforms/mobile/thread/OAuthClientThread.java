...
import static br.unifesp.offlineforms.mobile.util.Constants.OAUTH_CLIENT_ID;
import static br.unifesp.offlineforms.mobile.util.Constants.OAUTH_CLIENT_SECRET;
import static br.unifesp.offlineforms.mobile.util.Constants.OAUTH_REDIRECT_URI;
import static br.unifesp.offlineforms.mobile.util.Constants.OAUTH_RESPONSE_TYPE;
import static br.unifesp.offlineforms.mobile.util.Constants.URI_ACCESSTOKEN_REQUEST;
...
import br.unifesp.offlineforms.mobile.activities.LoginActivity;
import br.unifesp.offlineforms.mobile.activities.OAuthWebViewClient;
