...
import br.unifesp.offlineforms.mobile.model.components.form.AudioQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.BarCodeQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.CheckBoxQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.ComboBoxQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.DateQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.DecimalQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.DrawQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.GeoLocationQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.MoneyQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.NumberQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.PictureQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.RadioButtonQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.SliderQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.TextQuestion;
import br.unifesp.offlineforms.mobile.model.components.form.VideoQuestion;
