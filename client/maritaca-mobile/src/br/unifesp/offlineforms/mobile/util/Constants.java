...
public class Constants {
	...
	public static String PATH_FORM = "/data/data/br.unifesp.offlineforms.mobile.activities/form.xml";
	public static String PATH_CSV = "/data/data/br.unifesp.offlineforms.mobile.activities/form.csv";
